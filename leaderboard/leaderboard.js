...
$.getJSON(endpoint, function(data){
    ...
    CreateTableFromJSON(data["HIMYM-Quiz-Leaderboard"], "How I Met Your Mother Quiz", "himymLeaderboard");
    CreateTableFromJSON(data["Stranger-Things-Quiz-Leaderboard"], "Stranger Things Quiz", "strangerThingsLeaderboard");
